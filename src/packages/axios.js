!(function (e, t) {
        ...
        if (P.endsWith(r, '{}')) (r = i ? r : r.slice(0, -2)), (t = JSON.stringify(t));
          ...
          return (
            ...
            s.forEach(function (e, t) {
              !P.isUndefined(e) &&
                null !== e &&
                n.append(!0 === u ? L([r], t, a) : null === u ? r : r + '[]', f(e));
            }),
            !1
          );
  ...
  function V(e, t, n) {
    ...
    var r,
      ...
      i = n && n.serialize;
    if (
      (r = i ? i(t, n) : P.isURLSearchParams(t) ? t.toString() : new M(t, n).toString(o))
    ) {
      var s = e.indexOf('#');
  ...
  function he(e) {
    return new Promise(function (t, n) {
      ...
      if (
        ...
        var h =
          (e.withCredentials || ne(l)) && e.xsrfCookieName && ee.read(e.xsrfCookieName);
